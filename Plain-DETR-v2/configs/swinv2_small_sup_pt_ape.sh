...
python -u -m plain_detr.main \
    ...
    --args.backbone swin_v2_small_window16_2global \
    --args.drop_path_rate 0.1 \
    --args.upsample_backbone_output \
    --args.upsample_stride 16 \
    --args.num_feature_levels 1 \
    --args.decoder_type global_ape \
    --args.proposal_feature_levels 4 \
    --args.proposal_in_stride 16 \
    --args.pretrained_backbone_path ./pt_models/swinv2_small_patch4_window16_256_sup_pt.pth \
    --args.epochs 12 \
    --args.lr_drop 11 \
    --args.warmup 1000 \
    --args.lr 2e-4 \
    --args.lr_backbone 2e-5 \
    --args.lr_backbone_names backbone.0.net. \
