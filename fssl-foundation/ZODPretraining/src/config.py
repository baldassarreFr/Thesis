...
patch_size = (
    16  # Using smaller values leads to better performance but requires more memory.
)
drop_path_rate = 0.1
...
warmup_teacher_temp_epochs = (
    30  # Number of warmup epochs for the teacher temperature (Default: 30).
)
...
output_dir = "."  # change this to the folder containing checkpoint.pth file if you want to use pre-trained weights
saveckp_freq = 20
clip_grad = 3.0
