...
class ZODUnscaled(Dataset):
    ...
    def __init__(self, dataset_root="../../../../../mnt/ZOD/", version="full", transform=None):
        self.transform = transform
        self.class_mapping = {"Vehicle": 0, "VulnerableVehicle": 1, "Pedestrian": 2, "Animal": 3}
...
def generate_bbox_plots(image_index):
    ...
    dataset = ZODObjectDetection("../../../../../mnt/ZODversions/ZODCropped")
    img, target = dataset[image_index]
    bboxes = target["boxes"]
